...
export default defineConfig({
  server: {
    ...
    fs: {
      // Repository root. This client imports the shared TypeScript codec core
      // from pkg/quantize/ts, which is three levels up now that the example
      // lives at examples/space/web.
      allow: ["../../.."],
    },
  },
  resolve: {
