...
var updateShipDynGolden = flag.Bool("update-shipdyn-golden", false,
	"regenerate examples/space/web/src/__tests__/testdata/shipdyn_golden.json from the real systems")

// shipDynGoldenPath is the fixture consumed by
// examples/space/web/src/__tests__/prediction-golden.test.ts.
//
// Relative to this package's directory. The arity survived the move into
// examples/space/ unchanged: this package and the web client each descended
// by the same two levels.
const shipDynGoldenPath = "../../web/src/__tests__/testdata/shipdyn_golden.json"
...
func buildShipDynGolden(t *testing.T) shipDynGoldenManifest {
	...
	m := shipDynGoldenManifest{
		Note: "GENERATED by `just shipdyn-golden` from the real ShipDynamicsSystem + PhysicsSystem. " +
			"Do not hand-edit. Consumed by examples/space/web/src/__tests__/prediction-golden.test.ts, " +
			"which is what fails when examples/space/internal/game/system_ship_dynamics.go changes " +
			"without examples/space/web/src/prediction.ts.",
		TickIntervalMs: 50,
	}
...
//
// The fixture is the only thing that ties examples/space/web/src/prediction.ts stepShip
