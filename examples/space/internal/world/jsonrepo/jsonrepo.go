...
// Dir returns the directory this repository reads and writes. Reported by the
// world.export command so an operator learns where the manifests actually
// landed rather than a hardcoded guess.
