...
// reflect.Type as the spec is built, before any WorldBase exists.
func buildKindSpec[T any](kind uint8, name string, bindings *EngineBindingsConfig, notify func(reflect.Type)) func(*universe.WorldBase) {
