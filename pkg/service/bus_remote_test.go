...
func TestBus_RemotePublishCallback_FiresAfterLocalDispatch(t *testing.T) {
	...
	b.SetRoutingCache(map[string][]string{
		"github.com/zenion/mmoserver/pkg/service_test.remoteEvent": {"proc-B", "proc-C"},
	})
	...
	got := remoteCalls[0]
	if got.TypeName != "github.com/zenion/mmoserver/pkg/service_test.remoteEvent" {
...
func TestBus_PublishLocal_SkipsRemote(t *testing.T) {
	...
	b.SetRoutingCache(map[string][]string{
		"github.com/zenion/mmoserver/pkg/service_test.remoteEvent": {"proc-B"},
	})
...
func TestBus_RemotePublish_SelfSkipped(t *testing.T) {
	...
	b.SetRoutingCache(map[string][]string{
		"github.com/zenion/mmoserver/pkg/service_test.remoteEvent": {"proc-A", "proc-B"},
	})
