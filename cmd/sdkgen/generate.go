...
func (g *Generator) genEntities() string {
	...
	b.WriteString(" *\n")
	b.WriteString(" * - \"interpolated\": use per-entity producedAtMs to build a sample\n")
	b.WriteString(" *   ring; interpolate with RENDER_DELAY lag; run client-side\n")
	b.WriteString(" *   prediction for the local player. Smooth motion, ~100ms\n")
	b.WriteString(" *   visual lag, complex reconciliation.\n")
	b.WriteString(" *\n")
	b.WriteString(" * - \"snap\": render at the latest-received worldX/worldY. No sample\n")
	b.WriteString(" *   ring, no lerp, no prediction. Input latency is visible but\n")
	b.WriteString(" *   motion is always authoritative. League-of-Legends model.\n")
	b.WriteString(" *\n")
	b.WriteString(" * Game code should branch on this constant to enable/disable the\n")
	b.WriteString(" * prediction and interp paths.\n")
	b.WriteString(" */\n")
