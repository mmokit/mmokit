...
func snapshotBaseFields(w *quantize.SnapshotWriter, gw *GameWorld, ctx *gameNetContext, viewer *system.ViewerInfo, entry spatial.Entry) {
...
func hashCombat(h *mmokit.Hasher, gw *GameWorld, entity ecs.Entity) {
...
func snapshotCombat(w *quantize.SnapshotWriter, gw *GameWorld, entity ecs.Entity) {
