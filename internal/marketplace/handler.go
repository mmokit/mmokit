...
func RegisterHandlers(router *mmokit.OpRouter, svc *Settlement, stationID uint32) {
	...
	mmokit.RegisterOp[gamepb.MarketCreateOrderRequest, gamepb.MarketOrderResultResponse](
	...
	mmokit.RegisterOp[gamepb.MarketCancelOrderRequest, gamepb.MarketOrderResultResponse](
	...
	mmokit.RegisterOp[gamepb.MarketMyOrdersRequest, gamepb.MarketMyOrdersResponse](
	...
	mmokit.RegisterOp[gamepb.MarketInstantTradeRequest, gamepb.MarketOrderResultResponse](
