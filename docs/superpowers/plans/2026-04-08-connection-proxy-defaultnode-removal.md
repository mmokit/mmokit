...
Add `"github.com/mmokit/mmokit/pkg/net"` to coordinator.go imports if not present (needed for `net.PlayerEvent`).
...
Add `"github.com/mmokit/mmokit/pkg/coords"` and `"strings"` to main.go imports.
