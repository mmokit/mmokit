...
Add imports `reflect` and keep `github.com/mmokit/mmokit/pkg/tunable` + `github.com/mmokit/mmokit/pkg/wasmabi`. Append:
...
Add imports `github.com/mmokit/mmokit/pkg/tunable` and ensure `wasmabi` is imported. Add the compile-time assertion:
