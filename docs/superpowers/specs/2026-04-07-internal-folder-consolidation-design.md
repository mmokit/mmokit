...
2. **Remove cross-package imports**: delete all `"github.com/zenion/mmoserver/internal/system"` and `"github.com/zenion/mmoserver/internal/game"` imports from moved files (now same package)
