...
export enum GameClientEventCode {
  ...
  /**
   * @generated from enum value: GCE_INVENTORY_TRANSFER = 5;
   */
  GCE_INVENTORY_TRANSFER = 5,

  /**
   * @generated from enum value: GCE_BANK_REQUEST = 6;
   */
  GCE_BANK_REQUEST = 6,

  /**
   * @generated from enum value: GCE_SELL_BANK_ITEM = 7;
   */
  GCE_SELL_BANK_ITEM = 7,

  /**
   * @generated from enum value: GCE_EQUIP = 8;
   */
  GCE_EQUIP = 8,

  /**
   * @generated from enum value: GCE_SHOP_BUY = 9;
   */
  GCE_SHOP_BUY = 9,

  /**
   * @generated from enum value: GCE_DOCK = 10;
   */
  GCE_DOCK = 10,

  /**
   * @generated from enum value: GCE_UNDOCK = 11;
   */
  GCE_UNDOCK = 11,

  /**
   * @generated from enum value: GCE_LOOT_ITEM = 12;
   */
  GCE_LOOT_ITEM = 12,

  /**
   * @generated from enum value: GCE_LOOT_ALL = 13;
   */
  GCE_LOOT_ALL = 13,
}
...
export enum GameServerEventCode {
  ...
  /**
   * @generated from enum value: GSE_BANK_CONTENTS = 5;
   */
  GSE_BANK_CONTENTS = 5,

  /**
   * @generated from enum value: GSE_TRANSFER_RESULT = 6;
   */
  GSE_TRANSFER_RESULT = 6,

  /**
   * @generated from enum value: GSE_EQUIP_RESULT = 7;
   */
  GSE_EQUIP_RESULT = 7,

  /**
   * @generated from enum value: GSE_DOCKING_STATE = 8;
   */
  GSE_DOCKING_STATE = 8,

  /**
   * @generated from enum value: GSE_DOCKED = 9;
   */
  GSE_DOCKED = 9,

  /**
   * @generated from enum value: GSE_MAP_DATA = 13;
   */
  GSE_MAP_DATA = 13,
